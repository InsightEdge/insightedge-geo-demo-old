...
4. Launch Feeder `java -jar target/feeder.jar org.insightedge.geodemo.feeder.infinite.Feeder`. Alternatively you can run from IDE, see `org.insightedge.geodemo.feeder.Feeder`
